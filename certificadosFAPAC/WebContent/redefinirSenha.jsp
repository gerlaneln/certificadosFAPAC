...
<header class="cd-main-header">
	...
	if(request.getParameter("salvar")!=null){
		if(request.getParameter("senha").equals(administradorLogic.getSenha())){
			if(request.getParameter("nova").equals(request.getParameter("repetir"))){
				administrador.setLogin(administradorLogic.getLogin());
				administrador.setSenha(request.getParameter("nova"));
				administradorDB.atualizar(administrador);
				%>
				...
				%>
				<script type="text/javascript">
					alert("O campo senha nova e repetir senha não conferem.")
				</script>
				<%
			}
		}else{
	...
	<div style="margin: 90px 100px 100px"><!-- top right button left -->
			<form action="redefinirSenha.jsp">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Usário: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input name="user" type="text" disabled="disabled" size="15" value="<%=administradorLogic.getLogin()%>"><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Senha atual: &nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input name="senha" type="text" size="15"><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Nova senha: &nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input name="nova" type="password" size="15"><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Repita a senha: </label>
			<input name="repetir" type="password" size="15">
			<br><br><br>
