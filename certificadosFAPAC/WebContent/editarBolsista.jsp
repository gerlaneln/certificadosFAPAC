...
<header class="cd-main-header">
	...
	<main class="cd-main-content">
			...
			if(request.getParameter("salvar")!=null){
				...
				bolsistaLogic.setIDAluno(bolsistaLogic.getIDAluno());
				...
				eventoDB.deletarEventoAluno(idEvento, bolsistaLogic.getIDAluno());  // deleta evento_aluno
				int idProjeto = projetoDB.buscarProjetoAlunoPoIDA(bolsistaLogic.getIDAluno());
				projetoDB.deletarProjetoAluno(idProjeto, bolsistaLogic.getIDAluno());  // deleta projeto_aluno
				
				int idEventoNovo = Integer.parseInt(request.getParameter("editalEvento"));
				bolsistaEvento.setIdAluno(bolsistaLogic.getIDAluno());
				bolsistaEvento.setIdEvento(idEventoNovo);
				eventoDB.inserirEventoAluno(bolsistaEvento);
				
				int idProjetoNovo = Integer.parseInt(request.getParameter("projeto"));
				bolsistaProjeto.setIdAluno(bolsistaLogic.getIDAluno());
				bolsistaProjeto.setIdProjeto(idProjetoNovo);
				projetoDB.inserirProjetoAluno(bolsistaProjeto);
				
				bolsistaDB.atualizar(bolsistaLogic);
				response.sendRedirect("visualizarBolsistas.jsp");
		...
		<form action="editarBolsista.jsp" method="post">
		<h1>Editar: <%=bolsistaLogic.getNomeAluno() %></h1>
		...
		<select name="projeto" size="1" id="projeto" required="required" value="<%=bolsistaProjeto.getIdProjeto()%>">
		<%
		...
		<input type="text" name="nomeBolsista" size="60" required="required" autofocus="autofocus" value="<%=bolsistaLogic.getNomeAluno()%>">
		<br/>
		<br/>
		<label for="cpf">CPF: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		<input type="text" name="cpfBolsista" size="60" onkeypress="formatar(this, '###.###.###-##')" maxlength="14" required="required" autofocus="autofocus" value="<%=bolsistaLogic.getCPFAluno()%>">
		<br/>
		<br/>
