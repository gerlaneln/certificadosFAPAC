		...
		<div id="evento">
			<table class="table table-hover">
				...
				for(EventoDTO evento : eventos){
					...
					<tr>
					<td width="300">
					<label for="evento"><%=evento.getNomeEvento() %></label>
					</td>
					<td width="600">
					<label for="nomePrograma"><%=evento.getNomePrograma() %></label>
					</td>
					<td>
					<a href="editarEvento.jsp?n=<%=evento.getIDEvento()%>"><img src="./resources/images/editar.png" width="25" height="25"></a>
					</td>
					<td>
					<a href="deletarEvento.jsp?n=<%=evento.getIDEvento()%>"><img src="./resources/images/excluir.png" width="25" height="25"></a>
					</td>
				</tr>
					<%
				}
