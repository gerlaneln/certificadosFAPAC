<%@page import="br.acre.fapac.certificado.dto.AlunoDTO"%>
	...
	<main class="cd-main-content">
		...
		<div id="bolsista">
			<table class="table table-hover">
				...
				<%
				List<AlunoDTO>bolsistas = bolsistaDB.listarTodos();
				for(AlunoDTO bolsista : bolsistas){
					int idEvento = eventoDB.buscarEventoAlunoPoIDA(bolsista.getIDAluno());
					eventoLogic = eventoDB.buscarEventoPoID(idEvento);
					String nomeEvento = eventoLogic.getNomeEvento();
					%>
				<tr>
					<td width="1000">
					<label for="bolsista"><%=bolsista.getNomeAluno().toString() %></label>
					</td>
					<td>
					<label for="editalEvento"><%=nomeEvento.toString() %></label>
					</td>
					<td>
					<a href="editarBolsista.jsp?n=<%=bolsista.getIDAluno()%>"><img src="./resources/images/editar.png" width="25" height="25"></a>
					</td>
					<td>
					<a href="deletarBolsista.jsp?n=<%=bolsista.getIDAluno()%>"><img src="./resources/images/excluir.png" width="25" height="25"></a>
					</td>
				</tr>
					<%
				}
