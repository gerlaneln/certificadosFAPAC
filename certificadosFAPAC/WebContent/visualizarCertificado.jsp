		...
		<div id="certificado">		
			<table class="table table-hover">
				<tr>
					<th width="1000">
					Certificados
					<a href="cadastroCertificado.jsp"><input type="image" src="./resources/images/add-to-queue-button.png" width="20" height="20"></a>
					</th>
					<th>
					</th>
					<th>
				...
				<tr>
					<td width="1000">
					<a href="#0"><label for="certificado">Certificado 123456</label></a>
					</td>
					<td>
					<a href="editarCertificado.jsp"><img src="./resources/images/editar.png" width="25" height="25"></a>
					</td>
					<td>
					<a href="deletarCertificado.jsp"><img src="./resources/images/excluir.png" width="25" height="25"></a>
					</td>
				</tr>
			</table>
		<br/><br/><br/>
