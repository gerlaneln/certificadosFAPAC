...
%>
	...
	<jsp:setProperty name="diretorLogic" property="nomeDiretor" />
	<jsp:setProperty name="diretorLogic" property="cargoDiretor" />
	<jsp:setProperty name="diretorLogic" property="NDecreto" />
	
	<% diretorDB.inserir(diretorLogic); 
	response.sendRedirect("visualizarDiretor.jsp");
	%>
...
%>
	...
	<form action="cadastroDiretor.jsp" method="post">
		<label for="nome">Nome: &nbsp;&nbsp;&nbsp;</label>
		<input type="text" name="nomeDiretor" size="60" required="required" autofocus="autofocus">
		<br/><br/>
		<label for="cargo">Cargo: &nbsp;&nbsp;&nbsp;&nbsp;</label>
		<input type="text" name="cargoDiretor" size="60" required="required" autofocus="autofocus">
		<br/><br/>
		<label for="decreto">Decreto: &nbsp;</label>
		<input type="text" name="NDecreto" size="9" onkeypress="formatar(this, '####/####')" maxlength="9" required="required" autofocus="autofocus">
		<br/><br/><br/>
