		...
		<nav class="cd-nav">
			<ul class="cd-top-nav">
				<li class="has-children account">
					<a ><img src="./resources/images/cd-avatar.png" alt="avatar"><font color="#000000"><%=administradorLogic.getLogin() %></font></a>
				</li>
				<li class="has-children account">
					<a href="loginAdm.jsp">
						<font color="#000000">Sair</font>
					</a>
				</li>
			</ul>
		</nav>
		...
		<div id="evento">
			<table class="table table-hover">
				...
				for(EventoDTO evento : eventos){
					...
					<td>
					<a href="editarEvento.jsp"><img src="./resources/images/editar.png" width="25" height="25"></a>
					</td>
					<td>
					<a href="deletarEvento.jsp"><img src="./resources/images/excluir.png" width="25" height="25"></a>
					</td>
				</tr>
					<%
				}
	...
	<div id="diretor">
			<table class="table table-hover">
				<tr>
					<th width="400">
					Diretores
					<a href="cadastroDiretor.jsp"><input type="image" src="./resources/images/add-to-queue-button.png" width="20" height="20"></a>
					</th>
					<th width="600">
					Cargo
					</th>
				...
				for(DiretorDTO diretor : diretores){
					...
					<tr>
					<td width="300">
					<label for="diretor"><%=diretor.getNomeDiretor() %></label>
					</td>
					<td width="600">
					<label for="cargo"><%=diretor.getCargoDiretor() %></label>
					</td>
					<td>
					<a href="editarDiretor.jsp?n=<%=diretor.getIDDiretor()%>"><img src="./resources/images/editar.png" width="25" height="25"></a>
					</td>
					<td>
					<a href="deletarDiretor.jsp?a=<%=diretor.getIDDiretor()%>"><img src="./resources/images/excluir.png" width="25" height="25"></a>
					</td>
				</tr>
					<%
				}
