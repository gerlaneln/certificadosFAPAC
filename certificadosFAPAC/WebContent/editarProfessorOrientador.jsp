...
<header class="cd-main-header">
	...
	<main class="cd-main-content">
			...
			if(request.getParameter("n")!=null){
				...
				OrientadorLogic = OrientadorDB.buscarOrientadorPoID(Integer.parseInt(request.getParameter("n")));
		 		...
		 		if (request.getParameter("salvar") != null) {
		 			...
		 			OrientadorLogic.setIDOrientador(OrientadorLogic.getIDOrientador());
					...
					projetoDB.deletarProjetoOrientador(idProjeto, OrientadorLogic.getIDOrientador());  // deleta projeto_orientador
		 			...
		 			int chave = OrientadorLogic.getIDOrientador();
		 			
		 			int idEvento2 = Integer.parseInt(request.getParameter("editalEvento").toString());
		 			
		 			orientadorEvento.setIdEvento(idEvento2);
		 			orientadorEvento.setIdOrientador(chave);
		 			eventoDB.inserirEventoOrientador(orientadorEvento);	 // insere evento_orientador
		 			
		 			int idProjeto2 = Integer.parseInt(request.getParameter("projeto").toString());
		 			orientadorProjeto.setIdOrientador(chave);
		 			orientadorProjeto.setIdProjeto(idProjeto2);
		 			projetoDB.inserirProjetoOrientador(orientadorProjeto); // insere projeto_orientador
		 			
		 			OrientadorDB.atualizar(OrientadorLogic);
					response.sendRedirect("visualizarProfessor.jsp");
					...
					alert("Professor Orientador cadastrado com sucesso")
		 			...
		 			if (request.getParameter("coOrientador") != null) {
						...
						System.out.println(senha);
			 			...
			 			int chave = CoOrientadorDB.inserir(CoOrientadorLogic);
			 			
			 			int idEvento = Integer.parseInt(request.getParameter("editalEvento").toString());
			 			coOrientadorEvento.setIdEvento(idEvento);
			 			coOrientadorEvento.setIdCoorientador(chave);
			 			eventoDB.inserirEventoCoorientador(coOrientadorEvento);
			 			
			 			int idProjeto = Integer.parseInt(request.getParameter("projeto").toString());
			 			coorientadorProjeto.setIdCoorientador(chave);
			 			coorientadorProjeto.setIdProjeto(idProjeto);
			 			projetoDB.inserirProjetoCoorientador(coorientadorProjeto);
						
						
						int idEvento2 = eventoDB.buscarEventoOrientadorPoIDO(OrientadorLogic.getIDOrientador());
						eventoDB.deletarEventoOrientador(idEvento2, OrientadorLogic.getIDOrientador());  // deleta evento_orientador
						int idProjeto2 = projetoDB.buscarProjetoOrientadorPoIDO(OrientadorLogic.getIDOrientador());
						projetoDB.deletarProjetoOrientador(idProjeto2, OrientadorLogic.getIDOrientador());  // deleta projeto_orientador
		 				OrientadorDB.deletar(OrientadorLogic.getIDOrientador());
			 		
						response.sendRedirect("visualizarProfessor.jsp");
		 			
		 %> <script type="text/javascript">
					alert("Professor Coorientador cadastrado com sucesso")
				</script> <%
		 			}
		 		}
		 %>
		...
		<form action="editarProfessorOrientador.jsp" method="post">
		...
		%>
			 ...
			 <label for="nome">Nome:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="nomeOrientador" size="60" required="required" autofocus="autofocus" value="<%=OrientadorLogic.getNomeOrientador()%>" > <br /> <br />
			<label for="cpf">CPF:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="CPFOrientador" size="60" onkeypress="formatar(this, '###.###.###-##')" maxlength="14" required="required" autofocus="autofocus" value="<%=OrientadorLogic.getCPFOrientador()%>"> <br /> <br />
			<label for="coOrientador">Coorientador: </label> <input
				type="checkbox" name="coOrientador" > <br /> 
				<br /> <br />
