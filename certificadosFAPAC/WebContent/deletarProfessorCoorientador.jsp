...
<header class="cd-main-header">
	...
	<main class="cd-main-content">
	 	...
	 	%> <script type="text/javascript">
				alert("Professor Coorientador removido com sucesso")
			</script> <%
	 			}
		...
		<h1>Remoção de professor : <%=CoOrientadorLogic.getNomeCoorientador()%></h1>
		<form action="deletarProfessorCoorientador.jsp" method="post">
		...
		%>
			 ...
			 <label for="nome">Nome:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="nomeOrientador" size="60" value="<%=CoOrientadorLogic.getNomeCoorientador()%>" disabled > <br /> <br />
			<label for="cpf">CPF:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="CPFOrientador" size="60" onkeypress="formatar(this, '###.###.###-##')" maxlength="14" value="<%=CoOrientadorLogic.getCPFCoorientador()%>" disabled> <br /> <br />
			<label for="coOrientador">Coorientador: </label> <input
				type="checkbox" name="coOrientador" checked onclick="return false;" disabled> <br /> 
				<br /> <br />
