...
<nav class="cd-side-nav" style="position: fixed;">
 ...
 %>
	...
	<div class="content-wrapper">
		...
		<form action="cadastroProfessorOrientador.jsp" method="post">
			<label for="editalEvento">Edital/Evento: </label> <select
				name="editalEvento" size="1" id="editalEvento" required="required" >
				<%
			...
			<label for="projeto">Projeto: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> <select
				name="projeto" size="1" id="projeto" required="required">
				<%
					List<ProjetoDTO> projetos = projetoDB.listarTodos();
					for (ProjetoDTO projeto : projetos) {
				%>
				<option value="<%=projeto.getIDProjeto()%>"><%=projeto.getTituloProjeto().toString()%></option>
				<%
					}
				%>
			</select> <br /> <br />
			 <label for="nome">Nome:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="nomeOrientador" size="60" required="required" autofocus="autofocus"> <br /> <br />
			<label for="cpf">CPF:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="CPFOrientador" size="60" onkeypress="formatar(this, '###.###.###-##')" maxlength="14" required="required" autofocus="autofocus"> <br /> <br />
			<label for="coOrientador">Coorientador: </label> <input
				type="checkbox" name="coOrientador"> <br /> <br /> <br />
